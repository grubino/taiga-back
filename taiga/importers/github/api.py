...
class GithubImporterViewSet(viewsets.ViewSet):
    ...
    def authorize(self, request, *args, **kwargs):
        ...
        if code is None:
            return response.BadRequest({"error": "code-param-needed"})
        try:
            ...
            return response.BadRequest({"error": "invalid-auth-data"})
        except exceptions.InvalidAuthResult:
            return response.BadRequest({"error": "third-party-service-failing"})
